...
static GPBFileDescription LabelRoot_FileDescription = {
  .package = "google.api",
  .prefix = NULL,
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(LabelDescriptor)
                                   messageName:@"LabelDescriptor"
                               fileDescription:&LabelRoot_FileDescription
                                        fields:fields
