...
static GPBFileDescription MonitoredResourceRoot_FileDescription = {
  .package = "google.api",
  .prefix = NULL,
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(MonitoredResourceDescriptor)
                                   messageName:@"MonitoredResourceDescriptor"
                               fileDescription:&MonitoredResourceRoot_FileDescription
                                        fields:fields
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(MonitoredResource)
                                   messageName:@"MonitoredResource"
                               fileDescription:&MonitoredResourceRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
