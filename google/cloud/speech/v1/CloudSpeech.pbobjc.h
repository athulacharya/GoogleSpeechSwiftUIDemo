...
/** The number of items in @c speechContextsArray without causing the container to be created. */
...
/** The number of items in @c phrasesArray without causing the container to be created. */
...
/** The number of items in @c alternativesArray without causing the container to be created. */
...
/** The number of items in @c wordsArray without causing the container to be created. */
