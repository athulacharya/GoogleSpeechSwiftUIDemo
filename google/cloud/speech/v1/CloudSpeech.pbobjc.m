...
GPBObjCClassDeclaration(LongRunningRecognizeMetadata);
GPBObjCClassDeclaration(LongRunningRecognizeRequest);
GPBObjCClassDeclaration(LongRunningRecognizeResponse);
GPBObjCClassDeclaration(RecognitionAudio);
GPBObjCClassDeclaration(RecognitionConfig);
GPBObjCClassDeclaration(RecognizeRequest);
GPBObjCClassDeclaration(RecognizeResponse);
...
GPBObjCClassDeclaration(StreamingRecognizeRequest);
GPBObjCClassDeclaration(StreamingRecognizeResponse);
...
static GPBFileDescription CloudSpeechRoot_FileDescription = {
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(RecognizeRequest)
                                   messageName:@"RecognizeRequest"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(LongRunningRecognizeRequest)
                                   messageName:@"LongRunningRecognizeRequest"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(StreamingRecognizeRequest)
                                   messageName:@"StreamingRecognizeRequest"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(StreamingRecognitionConfig)
                                   messageName:@"StreamingRecognitionConfig"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(RecognitionConfig)
                                   messageName:@"RecognitionConfig"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(SpeechContext)
                                   messageName:@"SpeechContext"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(RecognitionAudio)
                                   messageName:@"RecognitionAudio"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(RecognizeResponse)
                                   messageName:@"RecognizeResponse"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(LongRunningRecognizeResponse)
                                   messageName:@"LongRunningRecognizeResponse"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(LongRunningRecognizeMetadata)
                                   messageName:@"LongRunningRecognizeMetadata"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(StreamingRecognizeResponse)
                                   messageName:@"StreamingRecognizeResponse"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(StreamingRecognitionResult)
                                   messageName:@"StreamingRecognitionResult"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(SpeechRecognitionResult)
                                   messageName:@"SpeechRecognitionResult"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(SpeechRecognitionAlternative)
                                   messageName:@"SpeechRecognitionAlternative"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(WordInfo)
                                   messageName:@"WordInfo"
                               fileDescription:&CloudSpeechRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
