 ...
 **/
GPB_FINAL @interface GPBDescriptorRoot : GPBRootObject
@end
 ...
 * files it parses.
 **/
GPB_FINAL @interface GPBFileDescriptorSet : GPBMessage

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<GPBFileDescriptorProto*> *fileArray;
/** The number of items in @c fileArray without causing the container to be created. */
 ...
 **/
GPB_FINAL @interface GPBFileDescriptorProto : GPBMessage
...
/** The number of items in @c dependencyArray without causing the container to be created. */
...
/** The number of items in @c publicDependencyArray without causing the container to be created. */
...
/** The number of items in @c weakDependencyArray without causing the container to be created. */
...
/** The number of items in @c messageTypeArray without causing the container to be created. */
...
/** The number of items in @c enumTypeArray without causing the container to be created. */
...
/** The number of items in @c serviceArray without causing the container to be created. */
...
/** The number of items in @c extensionArray without causing the container to be created. */
 ...
 **/
GPB_FINAL @interface GPBDescriptorProto : GPBMessage
...
/** The number of items in @c fieldArray without causing the container to be created. */
...
/** The number of items in @c nestedTypeArray without causing the container to be created. */
...
/** The number of items in @c extensionRangeArray without causing the container to be created. */
...
/** The number of items in @c oneofDeclArray without causing the container to be created. */
...
/** The number of items in @c reservedRangeArray without causing the container to be created. */
...
/** The number of items in @c reservedNameArray without causing the container to be created. */
...
GPB_FINAL @interface GPBDescriptorProto_ExtensionRange : GPBMessage
 ...
 * not overlap.
 **/
GPB_FINAL @interface GPBDescriptorProto_ReservedRange : GPBMessage
 ...
 **/
GPB_FINAL @interface GPBFieldDescriptorProto : GPBMessage
 ...
 * Describes a oneof.
 **/
GPB_FINAL @interface GPBOneofDescriptorProto : GPBMessage
 ...
 **/
GPB_FINAL @interface GPBEnumDescriptorProto : GPBMessage
 ...
 **/
GPB_FINAL @interface GPBEnumValueDescriptorProto : GPBMessage
 ...
 * Describes a service.
 **/
GPB_FINAL @interface GPBServiceDescriptorProto : GPBMessage
...
/** The number of items in @c methodArray without causing the container to be created. */
 ...
 **/
GPB_FINAL @interface GPBMethodDescriptorProto : GPBMessage
...
GPB_FINAL @interface GPBFileOptions : GPBMessage
...
/** The number of items in @c uninterpretedOptionArray without causing the container to be created. */
...
GPB_FINAL @interface GPBMessageOptions : GPBMessage
...
GPB_FINAL @interface GPBFieldOptions : GPBMessage
...
GPB_FINAL @interface GPBEnumOptions : GPBMessage
...
GPB_FINAL @interface GPBEnumValueOptions : GPBMessage
...
GPB_FINAL @interface GPBServiceOptions : GPBMessage
...
GPB_FINAL @interface GPBMethodOptions : GPBMessage
 ...
 * in them.
 **/
GPB_FINAL @interface GPBUninterpretedOption : GPBMessage

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<GPBUninterpretedOption_NamePart*> *nameArray;
/** The number of items in @c nameArray without causing the container to be created. */
 ...
 * "foo.(bar.baz).qux".
 **/
GPB_FINAL @interface GPBUninterpretedOption_NamePart : GPBMessage
 ...
 **/
GPB_FINAL @interface GPBSourceCodeInfo : GPBMessage
...
/** The number of items in @c locationArray without causing the container to be created. */
...
GPB_FINAL @interface GPBSourceCodeInfo_Location : GPBMessage
...
/** The number of items in @c spanArray without causing the container to be created. */
...
/** The number of items in @c leadingDetachedCommentsArray without causing the container to be created. */
 ...
 **/
GPB_FINAL @interface GPBGeneratedCodeInfo : GPBMessage
...
/** The number of items in @c annotationArray without causing the container to be created. */
...
GPB_FINAL @interface GPBGeneratedCodeInfo_Annotation : GPBMessage
