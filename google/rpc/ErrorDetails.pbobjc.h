...
/** The number of items in @c stackEntriesArray without causing the container to be created. */
...
/** The number of items in @c violationsArray without causing the container to be created. */
...
/** The number of items in @c fieldViolationsArray without causing the container to be created. */
