...
GPBObjCClassDeclaration(DebugInfo);
...
GPBObjCClassDeclaration(ResourceInfo);
...
static GPBFileDescription ErrorDetailsRoot_FileDescription = {
  .package = "google.rpc",
  .prefix = NULL,
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(RetryInfo)
                                   messageName:@"RetryInfo"
                               fileDescription:&ErrorDetailsRoot_FileDescription
                                        fields:fields
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(DebugInfo)
                                   messageName:@"DebugInfo"
                               fileDescription:&ErrorDetailsRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(QuotaFailure)
                                   messageName:@"QuotaFailure"
                               fileDescription:&ErrorDetailsRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(QuotaFailure_Violation)
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(BadRequest)
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(BadRequest_FieldViolation)
                                   messageName:@"FieldViolation"
                               fileDescription:&ErrorDetailsRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(ResourceInfo)
                                   messageName:@"ResourceInfo"
                               fileDescription:&ErrorDetailsRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(Help)
                                   messageName:@"Help"
                               fileDescription:&ErrorDetailsRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(Help_Link)
                                   messageName:@"Link"
                               fileDescription:&ErrorDetailsRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
